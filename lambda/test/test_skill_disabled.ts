// temporary remove the skill disabled test because of 
// https://github.com/alexa/alexa-skills-kit-sdk-for-nodejs/issues/469
...
import r from './request/skill_disabled.json'; // tslint:disable-line
